...
function updateQuantity(id, type)
	{
		...
		if(updatedValue>0)
		{
			...
			{
				 		$.ajax({
						url:'index.php?route=extension/payment/hips_checkout/main',	
						type:'POST',
						data:{'quantity':info, 'type':'partsection'},	
						success: function(data)
						{    
						 ...
						 $.ajax({
						url:'index.php?route=extension/payment/hips_checkout/leftHTML',	
						type:'POST',
		...
		$.ajax({
			...
			success: function(json) {
				...
				if (getURLVar('route') == 'checkout/cart' || getURLVar('route') == 'checkout/checkout') {
					...
					location = 'index.php?route=extension/payment/hips_checkout';
				}
			},
